    ...
    <v-container>
      <v-layout align-center justify-center row>
        <v-flex lg10 md10 sm8 xs12>
          <classifier-type-edit></classifier-type-edit>
        </v-flex>
      </v-layout>
    </v-container>
  </v-content>
...
<script lang="ts">
  ...
  import ClassifierTypeEdit from "../../components/nomenclador/nomencladorEdit/classifiertype.vue";

  export default {
    name: "onei-classifiertype-edit-page",
    components: {
      ClassifierTypeEdit,
      VContainer,
      VContent,
