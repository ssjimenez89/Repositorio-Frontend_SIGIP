    ...
    <v-container>
      <v-layout align-center justify-center row>
        <v-flex lg10 md10 sm8 xs12>
          <establecimiento-edit></establecimiento-edit>
        </v-flex>
      </v-layout>
    </v-container>
  </v-content>
...
<script lang="ts">
  ...
  export default {
    name: "onei-establecimiento-edit-page",
    components: {
      EstablecimientoEdit,
      VContainer,
      VContent,
    ...
    head: {
      title() {
        return {
          inner: this.$i18n.t(
            "applications.onei_ipc.modules.establecimiento.pages.edit_establecimiento.page_title"
          )
        };
      }
    }
