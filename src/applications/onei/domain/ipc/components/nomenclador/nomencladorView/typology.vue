...
<script lang="ts">
  ...
  import {QUERY_GET_CATEGORIES, TYPOLOGY_BY_ID} from "../../../components/nomenclador/graphql/graphql-nomenclador.js";
  ...
  export default {
    ...
    apollo: {
      ...
      typology: {
        ...
        update(data) {
          this.name = data.typologyById.description;
          this.active = data.typologyById.active;
          this.imputed = data.typologyById.imputed;
          this.categorySelected = data.typologyById.category.id;
          return data.typologyById;
        }
      }
    },
    created() {
      this.$apollo.queries.categories.refetch();
      this.$apollo.queries.typology.refetch()
    },
  }
</script>
