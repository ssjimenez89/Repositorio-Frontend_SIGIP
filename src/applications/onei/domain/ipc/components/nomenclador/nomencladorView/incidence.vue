...
<script lang="ts">
  ...
  import {INCIDENCE_BY_ID} from "../../../components/nomenclador/graphql/graphql-nomenclador.js";
  ...
  export default {
    ...
    apollo: {
      incidence: {
        ...
        update(data) {
          this.name = data.incidenceById.description;
          this.active = data.incidenceById.active;
          this.acronym = data.incidenceById.acronym;
          return data.incidenceById;
        }
      }
    },
    created() {
      this.$apollo.queries.incidence.refetch()
    },
  }
</script>
