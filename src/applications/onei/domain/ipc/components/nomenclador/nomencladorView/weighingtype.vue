...
<script lang="ts">
  ...
  import {WEIGHINGTYPE_BY_ID} from "../../../components/nomenclador/graphql/graphql-nomenclador.js";

  export default {
    name: "weighingtypeView",
    components: {
      VCard,
      VCardTitle,
      VCardText,
    ...
    apollo: {
      weighingtype: {
        ...
        update(data) {
          this.description = data.weighingTypeById.description;
          this.active = data.weighingTypeById.active;
          return data.weighingTypeById;
        }
      }
    },
    created() {
      this.$apollo.queries.weighingtype.refetch()
    },
  }
</script>
