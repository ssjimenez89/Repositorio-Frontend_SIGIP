...
<script lang="ts">
  ...
  import {VARIETYTYPE_BY_ID} from "../../../components/nomenclador/graphql/graphql-nomenclador.js";

  export default {
    name: "varietytypeView",
    components: {
      VCard,
      VCardTitle,
      VCardText,
    ...
    apollo: {
      varietytype: {
        ...
        update(data) {
          this.description = data.varietyTypeById.description;
          this.active = data.varietyTypeById.active;
          return data.varietyTypeById;
        }
      }
    },
    created() {
      this.$apollo.queries.varietytype.refetch()
    },
  }
</script>
