...
<script lang="ts">
  ...
  import {MEASUREMENTUNITTYPE_BY_ID} from "../../../components/nomenclador/graphql/graphql-nomenclador.js";

  export default {
    name: "measurementunittypeView",
    components: {
      VCard,
      VCardTitle,
      VCardText,
    ...
    apollo: {
      measurementunittype: {
        ...
        update(data) {
          this.description = data.measurementUnitTypeById.description;
          this.active = data.measurementUnitTypeById.active;
          return data.measurementUnitTypeById;
        }
      }
    },
    created() {
      this.$apollo.queries.measurementunittype.refetch()
    },
  }
</script>
