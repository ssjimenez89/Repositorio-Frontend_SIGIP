...
<script lang="ts">
  ...
  import {CLASSIFIERTYPE_BY_ID} from "../../../components/nomenclador/graphql/graphql-nomenclador.js";

  export default {
    name: "classifiertypeView",
    components: {
      VCard,
      VCardTitle,
      VCardText,
    ...
    apollo: {
      classifiertype: {
        ...
        update(data) {
          this.description = data.classifierTypeById.description;
