...
<script lang="ts">
  ...
  import {OBSERVATION_BY_ID} from "../../../components/nomenclador/graphql/graphql-nomenclador.js";
  ...
  export default {
    ...
    apollo: {
      observation: {
        ...
        update(data) {
          this.name = data.observationById.description;
          this.active = data.observationById.active;
          this.acronym = data.observationById.acronym;
          return data.observationById;
        }
      }
    },
    created() {
      this.$apollo.queries.observation.refetch()
    },
  }
</script>
