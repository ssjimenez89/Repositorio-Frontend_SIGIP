...
<script lang="ts">
  ...
  import {CATEGORY_BY_ID, EDIT_CATEGORY_MUTATION} from "../../../components/nomenclador/graphql/graphql-nomenclador.js";
    ...
    apollo: {
      category: {
        ...
        update(data) {
          ...
          this.description = data.categoryById.description;
          this.active = data.categoryById.active;
