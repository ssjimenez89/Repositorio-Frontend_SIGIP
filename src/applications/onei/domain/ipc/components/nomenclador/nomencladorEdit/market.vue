...
<script lang="ts">
  ...
  import {EDIT_MARKET_MUTATION, MARKET_BY_ID} from "../../../components/nomenclador/graphql/graphql-nomenclador.js";
  ...
  export default {
    ...
    apollo: {
      market: {
        ...
        update(data) {
          this.name = data.marketById.description;
          this.active = data.marketById.active;
    ...
    created() {
      this.$apollo.queries.market.refetch()
    },
    computed: {
      formIsValid(): boolean {
        return (
