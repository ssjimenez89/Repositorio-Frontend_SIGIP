...
<script lang="ts">
    ...
    import {CARGO_BY_ID, EDIT_CARGO_MUTATION} from "../../../components/nomenclador/graphql/graphql-nomenclador.js";
        ...
        apollo: {
            cargo: {
                ...
                update(data) {
                  ...
                  debugger;
                    this.descripcion = data.cargoById.descripcion;
                    this.activo = data.cargoById.activo;
                    return data.cargoById;
                }
            }
        },
        methods: {
