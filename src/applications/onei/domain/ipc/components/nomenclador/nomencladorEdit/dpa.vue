...
<script lang="ts">
  ...
  import {DPA_BY_ID,QUERY_GET_REGIONES, EDIT_DPA_MUTATION} from "../../../components/nomenclador/graphql/graphql-nomenclador.js";
  import {QUERY_GET_CATEGORIES} from "../../../components/nomenclador/graphql/graphql-nomenclador";
  ...
  export default {
    ...
    apollo: {
      ...
      dpa: {
        ...
        update(data) {
          this.name = data.dpaById.description;
          this.active = data.dpaById.active;
          this.code = data.dpaById.code;
          this.regionSelected = data.dpaById.region.id;
          return data.dpaById;
        }
      }
    },
    ...
    created() {
      this.$apollo.queries.dpa.refetch()
      this.$apollo.queries.regiones.refetch()
    },
    computed: {
      formIsValid(): boolean {
        return (
