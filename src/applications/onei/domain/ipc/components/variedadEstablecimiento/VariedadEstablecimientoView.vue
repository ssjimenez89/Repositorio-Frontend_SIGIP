  ...
  <v-card class="add_container">
    <v-layout row>
      <loading-dialog v-model="$apollo.queries.varietyEstablishment.loading"
                      message="Cargando Visualizar variedad establecimiento">
        ...
        <v-card class="card--flex-toolbar">
          <v-toolbar card color="primary" dark>
            <v-toolbar-title class="subheading">
              {{$t('applications.onei_ipc.modules.variedadEstablecimiento.pages.view_variedad_establecimiento.form_title')}}
            </v-toolbar-title>
            <v-spacer></v-spacer>
          </v-toolbar>
          <v-divider></v-divider>
              ...
              <v-layout>
                <v-flex md12 xs12>
                  <v-card-actions>
                    ...
                    <v-btn
                      color="primary"
                      to="/onei/sigip/ipc/variedadEstablecimiento"
                    >
                      Cerrar
                    </v-btn>
                  </v-card-actions>
...
<script lang="ts">
  ...
  import {VARIETY_ESTABLISHMENT_BY_ID, VARIETY_ESTABLISHMENT_RESOURCE_BY_ID} from "../../components/variedadEstablecimiento/graphql/graphql.js";
