...
<script lang="ts">
  ...
  export default {
    name: "onei-reporte-precio-promedio-mercado-agropecuario",
    components: {
      VLayout,
      VFlex,
      VForm,
    ...
    data() {
      return {
        ...
        ruta: '/Reportes_SIGIP/Reportes/Precio_promedio_mercado_agropecuario',
      };
    },
    ...
    methods: {
      buscar() {
        if (!this.filtrodpa && !this.filtrovariedad) {
