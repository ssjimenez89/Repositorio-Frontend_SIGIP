...
<script lang="ts">
  ...
  export default {
    name: "onei-reporte-captaciones-mercado-agropecuario",
    components: {
    ...
    data() {
      return {
        ...
        ruta: '/Reportes_SIGIP/Reportes/Captaciones_del_Mercado_Agropecuario',
      };
    },

    methods: {
      buscar() {
        if (!this.filtrodpa && !this.filtroestablecimiento) {
